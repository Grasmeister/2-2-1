...
берущая данные из файла db.properties.
...
CREATE TABLE `schema_users_cars`.`cars` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `model` VARCHAR(45) NOT NULL,
  `series` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`id`));

CREATE TABLE `schema_users_cars`.`users` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_cars_idx` (`car_id` ASC) VISIBLE,
  CONSTRAINT `fk_cars`
    FOREIGN KEY (`car_id`)
    REFERENCES `schema_users_cars`.`cars` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION);